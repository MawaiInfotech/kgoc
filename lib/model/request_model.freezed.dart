...
abstract class $RequestModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, String message, String result});
}
...
class _$RequestModelImpl implements _RequestModel {
  const _$RequestModelImpl(
      {this.status = "", this.message = "", this.result = ""});
  ...
  @override
  String toString() {
    return 'RequestModel(status: $status, message: $message, result: $result)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, status, message, result);
...
abstract class _RequestModel implements RequestModel {
  const factory _RequestModel(
      {final String status,
      final String message,
      final String result}) = _$RequestModelImpl;
